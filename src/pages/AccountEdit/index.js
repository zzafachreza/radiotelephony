    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyGap jarak={20} />
                <MyInput label="Kelas" iconname="home-outline" value={kirim.kelas} onChangeText={x => setKirim({ ...kirim, kelas: x })} />
                <MyGap jarak={20} />
                <MyInput label="NIT" iconname="card-outline" value={kirim.nit} onChangeText={x => setKirim({ ...kirim, nit: x })} />
                <MyGap jarak={20} />
